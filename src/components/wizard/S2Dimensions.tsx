...
export const S2Dimensions: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mode Selector Tabs */}
      <div className="flex flex-wrap justify-center gap-1 border-b border-[#E4E7EC] pb-2">
        <button
          type="button"
          ...
          className={`px-4 py-2 rounded-lg text-xs font-medium flex items-center space-x-2 transition-colors cursor-pointer ${
            sizingMode === 'cabinet'
              ? 'bg-[#F2F4F7] text-[#101828] font-semibold border-b-2 border-[#12B76A]'
              : 'text-[#667085] hover:text-[#101828]'
          }`}
        >
          <Grid3X3 className="w-3.5 h-3.5 text-[#667085]" />
        ...
        >
          <Ruler className="w-3.5 h-3.5 text-[#667085]" />
        ...
        >
          <Monitor className="w-3.5 h-3.5 text-[#667085]" />
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg text-xs font-medium flex items-center space-x-2 transition-colors cursor-pointer ${
            sizingMode === 'comparison'
              ? 'bg-[#ECFDF3] text-[#027A48] font-semibold border border-[#A6F4C5]'
              : 'text-[#027A48] bg-[#F7FDF9] border border-[#D1FADF] hover:bg-[#ECFDF3]'
          }`}
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 bg-white p-6 rounded-xl space-y-5 border border-[#E4E7EC] shadow-sm">
          
          {/* TAB 4: COMPARATORE PASSI E LUMINOSITÀ */}
          {sizingMode === 'comparison' ? (
            <div className="space-y-4">
              {/* Barra Superiore con Opzioni */}
              <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-[#E4E7EC] pb-3 gap-2">
                <div className="flex items-center space-x-2 text-xs font-semibold text-[#101828]">
                  <Zap className="w-4 h-4 text-[#12B76A] flex-shrink-0" />
                  <span>Confronto Passi &amp; Nit</span>
                  <span className="text-xs text-[#667085] font-normal">({dimensions.areaM2.toFixed(1)} m²)</span>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {/* Schermo A */}
                <div className="p-4 rounded-xl border border-[#E4E7EC] bg-[#F7F8FA] space-y-3.5 text-xs">
                  <div className="flex justify-between items-center text-[#101828] font-semibold">
                    <span>Display A</span>
                    <span className="text-[10px] px-2 py-0.5 rounded bg-[#E4E7EC] text-[#344054] font-medium">Passo Fine</span>
                  </div>

                  <div>
                    <label className="text-xs text-[#667085] block mb-1">Passo Pixel (Pitch):</label>
                    <select
                      ...
                      className="w-full p-2 rounded-lg bg-white border border-[#D0D5DD] text-[#101828] outline-none font-medium text-xs"
                    >
                  ...
                  <div>
                    <div className="flex justify-between items-center text-xs text-[#667085] mb-1">
                      <span>Luminosità:</span>
                      <div className="flex items-center space-x-1.5">
                        {effectiveNitsA >= limitA.maxNits && (
                          <span className="text-[10px] text-[#B54708] bg-[#FEF0C7] px-1.5 py-0.5 rounded border border-[#FEDF89] flex items-center space-x-0.5">
                            <Lock className="w-2.5 h-2.5 inline" />
                            <span>Max Fisico</span>
                          </span>
                        )}
                        <strong className="text-[#101828] font-semibold tabular-nums">{fmt(effectiveNitsA)} nit</strong>
                      </div>
                    </div>
                    <input
                      type="range"
                      ...
                      className="w-full b2b-slider"
                    />
                    <div className="flex justify-between items-center text-[10px] text-[#98A2B3] pt-0.5 tabular-nums">
                      <span>3.000 nit</span>
                      <span className="text-[#667085] font-medium">Tetto: {fmt(limitA.maxNits)} nit ({limitA.chipType.split(' ')[0]})</span>
                    </div>
                  </div>

                  {/* Dettagli Tecnici */}
                  {!syntheticMode && (
                    <div className="pt-2 border-t border-[#E4E7EC] space-y-1.5 text-xs">
                      <div className="flex justify-between text-[#667085]">
                        <span>Package / Diodi:</span>
                        <strong className="text-[#101828] font-medium">{limitA.chipType}</strong>
                      </div>
                      <div className="flex justify-between text-[#667085]">
                        <span>Densità pixel:</span>
                        <strong className="text-[#101828] font-medium tabular-nums">{fmt(compResA.pixelM2)} px/m²</strong>
                      </div>
                      <div className="flex justify-between text-[#667085]">
                        <span>Potenza Max:</span>
                        <strong className="text-[#F04438] font-medium tabular-nums">{compResA.pMaxWmq} W/m²</strong>
                      </div>
                      <div className="flex justify-between text-[#667085]">
                        <span>Potenza Media (30% APL):</span>
                        <strong className="text-[#101828] font-medium tabular-nums">{compResA.pMedioWmq} W/m²</strong>
                      </div>
                    </div>
                  )}

                  {/* Card Costo Elettricità */}
                  <div className="p-3 rounded-lg bg-white border border-[#E4E7EC] text-center space-y-0.5">
                    <span className="text-[10px] text-[#667085] uppercase tracking-wider block font-medium">
                      Costo Energia Elettrica
                    </span>
                    <div className="text-xl font-semibold text-[#101828] tabular-nums tracking-tight">
                      {fmt(compResA.annualCostEur)} €<span className="text-xs text-[#667085] font-normal"> / anno</span>
                    </div>
                    <span className="text-xs text-[#667085] tabular-nums block">
                  ...
                  <button
                    ...
                    className="w-full py-2 rounded-lg bg-white hover:bg-[#F9FAFB] border border-[#D0D5DD] text-[#344054] font-medium text-xs transition-colors cursor-pointer"
                  >
                ...
                {/* Schermo B */}
                <div className="p-4 rounded-xl border border-[#A6F4C5] bg-[#F7FDF9] space-y-3.5 text-xs">
                  <div className="flex justify-between items-center text-[#12B76A] font-semibold">
                    <span>Display B</span>
                    <span className="text-[10px] px-2 py-0.5 rounded bg-[#ECFDF3] text-[#027A48] border border-[#A6F4C5] font-medium">Alta Efficienza</span>
                  </div>
                    ...
                    <div className="flex justify-between items-center text-xs text-[#667085] mb-1">
                      ...
                      <div className="flex items-center space-x-1.5">
                        {effectiveNitsB >= 12000 ? (
                          <span className="text-[10px] text-[#B54708] bg-[#FEF0C7] px-1.5 py-0.5 rounded border border-[#FEDF89] font-medium">
                            Gold Wire 12.000 nit
                          </span>
                        ) : effectiveNitsB >= 10000 ? (
                          <span className="text-[10px] text-[#027A48] bg-[#ECFDF3] px-1.5 py-0.5 rounded border border-[#A6F4C5] font-medium">
                            High-Power DOOH
                          </span>
                        ) : syncNits && effectiveNitsB === effectiveNitsA ? (
                          <span className="text-[10px] text-[#344054] bg-[#F2F4F7] px-1.5 py-0.5 rounded border border-[#D0D5DD]">
                            Pari ad A
                          </span>
                        ) : null}
                    ...
                    <div className="flex flex-wrap items-center gap-1.5 pt-1.5">
                      <button
                        ...
                        className={`px-2.5 py-1 rounded text-xs transition-colors cursor-pointer ${
                          syncNits || effectiveNitsB === effectiveNitsA
                            ? 'bg-[#ECFDF3] text-[#027A48] border border-[#A6F4C5] font-semibold'
                            : 'bg-white text-[#667085] hover:text-[#101828] border border-[#D0D5DD]'
                        }`}
                      >
                        ...
                        <button
                          ...
                          className={`px-2.5 py-1 rounded text-xs transition-colors cursor-pointer ${
                            !syncNits && effectiveNitsB === 12000
                              ? 'bg-[#FEF0C7] text-[#B54708] border border-[#FEDF89] font-semibold'
                              : 'bg-white text-[#B54708] hover:bg-[#FEF0C7] border border-[#FEDF89]'
                          }`}
                        >
                  ...
                  {!syntheticMode && (
                    <div className="pt-2 border-t border-[#E4E7EC] space-y-1.5 text-xs">
                      <div className="flex justify-between text-[#667085]">
                        <span>Package / Diodi:</span>
                        <strong className="text-[#101828] font-medium">{limitB.chipType}</strong>
                      </div>
                      <div className="flex justify-between text-[#667085]">
                        <span>Densità pixel:</span>
                        <strong className="text-[#101828] font-medium tabular-nums">{fmt(compResB.pixelM2)} px/m²</strong>
                      </div>
                      <div className="flex justify-between text-[#667085]">
                        <span>Potenza Max:</span>
                      ...
                      <div className="flex justify-between text-[#667085]">
                        <span>Potenza Media (30% APL):</span>
                        <strong className="text-[#101828] font-medium tabular-nums">{compResB.pMedioWmq} W/m²</strong>
                      </div>
                    </div>
                  )}

                  {/* Card Costo Elettricità */}
                  <div className="p-3 rounded-lg bg-white border border-[#A6F4C5] text-center space-y-0.5">
                    <span className="text-[10px] text-[#667085] uppercase tracking-wider block font-medium">
                      Costo Energia Elettrica
                    </span>
                    <div className="text-xl font-semibold text-[#12B76A] tabular-nums tracking-tight">
                      {fmt(compResB.annualCostEur)} €<span className="text-xs text-[#667085] font-normal"> / anno</span>
                    </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-[#E4E7EC] space-y-3 shadow-sm">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  ...
                  {deltaCostEur > 0 && (
                    <span className="text-xs px-3 py-1 rounded-full bg-[#ECFDF3] text-[#027A48] font-semibold border border-[#A6F4C5] self-start sm:self-auto tabular-nums">
                ...
                <div className="pt-2 border-t border-[#E4E7EC] flex flex-wrap items-center justify-between gap-2 text-xs">
                  <button
                    type="button"
                  ...
                  <button
                    type="button"
                    onClick={() => setSyntheticMode(!syntheticMode)}
                    className="text-[#667085] hover:text-[#101828] underline cursor-pointer transition-colors"
                  >
                ...
                {showDeepScientific && (
                  <div className="p-3.5 rounded-lg bg-[#F7F8FA] border border-[#E4E7EC] text-xs text-[#344054] leading-relaxed space-y-3">
                    <div className="flex items-center space-x-2 text-[#101828] font-semibold">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                      <div className="p-2.5 rounded bg-white border border-[#E4E7EC] space-y-1">
                        <strong className="text-[#101828] block">1. Perché il P3.91 non supera 6.500 nit:</strong>
                      ...
                      <div className="p-2.5 rounded bg-[#FEF0C7]/40 border border-[#FEDF89] space-y-1 sm:col-span-2">
                        <strong className="text-[#B54708] flex items-center space-x-1.5">
                          <Sparkles className="w-3.5 h-3.5 text-[#B54708]" />
            ...
            <>
              {/* Passo Pixel Presets */}
              <div>
                <label className="block text-xs font-semibold text-[#667085] mb-2 uppercase tracking-wide">
                  Passo Pixel (Pitch):
                </label>
                  ...
                  {PIXEL_PITCH_PRESETS.map((p) => (
                    <button
                      ...
                      className={`px-3.5 py-1.5 rounded-lg text-xs font-medium transition-colors cursor-pointer ${
                        pitchMm === p
                          ? 'border border-[#12B76A] bg-[#ECFDF3] text-[#027A48] font-semibold'
                          : 'border border-[#D0D5DD] bg-white text-[#344054] hover:border-[#12B76A]'
                      }`}
                    >
                      P{p} mm
                    </button>
                      ...
                      {CABINET_FORMATS.map((f) => (
                        <button
                          ...
                          className={`p-3 rounded-lg text-left text-xs border transition-colors cursor-pointer ${
                            formatId === f.id
                              ? 'border-[#12B76A] bg-[#ECFDF3] text-[#101828]'
                              : 'border-[#E4E7EC] bg-white text-[#667085] hover:border-[#D0D5DD]'
                          }`}
                        >
                          <div className="font-semibold text-[#101828]">Cabinet {f.name}</div>
                          <div className="text-xs text-[#667085] mt-0.5">Peso: ~{f.weightKg} kg/cabinet</div>
                        </button>
                      ))}
                    </div>
                  </div>
              ...
              {sizingMode === 'dimensions' && (
                <div className="space-y-4 pt-1 text-xs">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-[#667085] mb-1 font-medium">Larghezza Base (m):</label>
                      <input
                        type="number"
                        step="0.1"
                        min="1"
                        ...
                        className="w-full p-2.5 rounded-lg bg-white border border-[#D0D5DD] text-[#101828] text-base focus:border-[#12B76A] outline-none tabular-nums"
                      />
                    </div>
                    <div>
                      <label className="block text-[#667085] mb-1 font-medium">Altezza (m):</label>
                      <input
                        type="number"
                        step="0.1"
                        min="1"
              ...
              {sizingMode === 'resolution' && (
                <div className="space-y-4 pt-1 text-xs">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-[#667085] mb-1 font-medium">Pixel Orizzontali:</label>
                      <input
                        type="number"
                        step="32"
                        min="128"
                    ...
                    <div>
                      <label className="block text-[#667085] mb-1 font-medium">Pixel Verticali:</label>
                      <input
                        type="number"
                        step="32"
                        min="128"
        ...
        <div className="bg-white p-6 rounded-xl border border-[#E4E7EC] shadow-sm flex flex-col justify-between space-y-5">
          <div className="space-y-4">
            <div className="text-xs font-semibold text-[#101828] tracking-wider uppercase border-b border-[#E4E7EC] pb-2">
              Riepilogo Parametri
            </div>

            <div className="space-y-2.5 text-xs">
              <div className="flex justify-between py-1.5 border-b border-[#F2F4F7]">
                <span className="text-[#667085]">Superficie:</span>
                <span className="text-[#101828] font-semibold tabular-nums">{dimensions.areaM2.toFixed(2)} m²</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-[#F2F4F7]">
                <span className="text-[#667085]">Dimensioni:</span>
                <span className="text-[#101828] font-semibold tabular-nums">
                  {dimensions.widthM.toFixed(2)} × {dimensions.heightM.toFixed(2)} m
                </span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-[#F2F4F7]">
                <span className="text-[#667085]">Totale Cabinet:</span>
                <span className="text-[#12B76A] font-semibold tabular-nums">
                  {dimensions.totalCabinets} cabinet ({modulesW} col × {modulesH} righe)
                </span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-[#F2F4F7]">
                <span className="text-[#667085]">Formato Cabinet:</span>
                <span className="text-[#101828] font-medium">Cabinet {format.name}</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-[#F2F4F7]">
                <span className="text-[#667085]">Passo Selezionato:</span>
                <span className="text-[#101828] font-semibold tabular-nums">P{pitchMm} mm</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-[#F2F4F7]">
                <span className="text-[#667085]">Risoluzione:</span>
                <span className="text-[#101828] font-semibold tabular-nums">
                  {dimensions.resolutionX} × {dimensions.resolutionY} px
                </span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-[#F2F4F7]">
                <span className="text-[#667085]">Peso stimato:</span>
                <span className="text-[#344054] tabular-nums">~{dimensions.weightKg} kg</span>
              </div>
            </div>
          </div>
